...
public final class StorageGodObjectTreeNode extends ClickableTreeNode {

  private final transient StorageEntryTrackingService trackingService;

  public StorageGodObjectTreeNode(final GodObjectEntry godObjectEntry,
                                  final StorageEntryTrackingService trackingService) {
    super(godObjectEntry);
  ...
  public String toString() {
    final var godObjectEntry = (GodObjectEntry) userObject;
    return trackingService.getUserData(godObjectEntry)
        .map(StorageEntryTrackingService.StorageEntryUserData::name)
        .filter(it -> !it.isBlank())
        .orElseGet(godObjectEntry::displayName);
  }
