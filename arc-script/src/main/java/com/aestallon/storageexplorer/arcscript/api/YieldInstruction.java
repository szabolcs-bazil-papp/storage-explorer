...
public interface YieldInstruction {
  ...
  QueryInstruction.Column col(String prop);

  void col(String prop, String... props);

  QueryInstruction.Column col(ArcLiteral al);

  void col(ArcLiteral al, ArcLiteral... als);
